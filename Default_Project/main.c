...
void start_menu(void)
{
  ...
  lcd_write_string("PB1=next page");
  lcd_set_ddram_addr(LCD_LINE2_ADDR);
  lcd_write_string("PB2=select");
  while(!g_pb2_pressed){}
  ...
  while(!done){
    ...
    switch(page)
    {
      ...
      case 0:   
        ...
        lcd_write_string("Page 0         ");
        lcd_set_ddram_addr(LCD_LINE2_ADDR);
        lcd_write_string("Temp + Humidty  ");

        if(g_pb2_pressed){
          lcd_clear();
          lcd_set_ddram_addr(LCD_LINE1_ADDR);
          lcd_write_string("select pressed");
          msec_delay(2000);
          g_pb2_pressed = false;
          msec_delay(10);
        }
      ...
      case 1:
        lcd_set_ddram_addr(LCD_LINE1_ADDR);
        lcd_write_string("Page 1          ");
        lcd_set_ddram_addr(LCD_LINE2_ADDR);
        lcd_write_string("Controls?       ");
      ...
      case 2:
        lcd_set_ddram_addr(LCD_LINE1_ADDR);
        lcd_write_string("Page 2          ");
        lcd_set_ddram_addr(LCD_LINE2_ADDR);
        lcd_write_string("More stuff      ");
      ...
      case 3:
        lcd_set_ddram_addr(LCD_LINE1_ADDR);
        lcd_write_string("Page 3          ");
        lcd_set_ddram_addr(LCD_LINE2_ADDR);
        lcd_write_string("even more stuff ");
